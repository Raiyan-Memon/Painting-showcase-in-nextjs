                ...
                <div className="container-fluid">
                    <div className="row h-25 align-items-center">
                        <div className="col-3 text-center p-0">
                            <Link className={'nav-link p-1' + (pathname == "/" ? ' active' : '')} aria-current="page" href="/"><span className=""><svg className="mx-3" fill="white" xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 -960 960 960" width="30"><path d="M220-180h150v-250h220v250h150v-390L480-765 220-570v390Zm-60 60v-480l320-240 320 240v480H530v-250H430v250H160Zm320-353Z" /></svg> Home</span></Link>
                        </div>
                        <div className="col-6">
                            <h6 className="text-center">Manasi Arts &#10084;</h6>
                        </div>
